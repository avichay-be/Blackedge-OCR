    ...
    async def execute(
        ...
        try:
            ...
            if should_validate:
                ...
                # Use Mistral as secondary for Azure DI
                validation_service = ValidationService(secondary_client=factory.mistral)
                ...
                if validated.used_secondary:
                    metadata["primary_provider"] = "azure_di"
                    metadata["final_provider"] = "mistral"
